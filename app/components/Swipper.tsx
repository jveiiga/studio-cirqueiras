    ...
    <div className="max-w-[1800px] mx-auto">
      ...
      >
        <SwiperSlide className="">
          <div className="relative mx-5 h-[400px] sm:w-[90%] sm:h-[800px] sm:mx-auto lg:mx-auto lg:max-w-[370px] xl:w-full rounded-2xl overflow-hidden">
        ...
        <SwiperSlide className="">
          <div className="relative mx-5 h-[400px] sm:w-[90%] sm:h-[800px] sm:mx-auto lg:mx-auto lg:max-w-[370px] xl:w-full h-[562px] rounded-2xl overflow-hidden">
